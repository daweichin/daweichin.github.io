...
var Particle = /*#__PURE__*/function () {
  ...
  _createClass(Particle, [{
    ...
    value: function draw() {
      ...
      c.save();
      c.beginPath();
      c.arc(this.x, this.y, this.radius, 0, Math.PI * 2, false); // c.shadowColor = this.color;
      // c.shadowBlur = 15;
...
backgroundGradient.addColorStop(1, "#3f586b"); // Animation Loop
...
function animate() {
  ...
  c.fillRect(0, 0, canvas.width, canvas.height); // Rotate Entire Canvas
